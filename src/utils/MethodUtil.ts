...
export const testEthSign: () => Promise<any> = async (
  web3Provider?: ethers.providers.Web3Provider,
) => {
  // if (!web3Provider) {
  //   throw new Error('web3Provider not connected');
...
export const testSignTypedData: () => Promise<any> = async (
  web3Provider?: ethers.providers.Web3Provider,
) => {
  // if (!web3Provider) {
  //   throw new Error('web3Provider not connected');
...
export const testSendTransaction: () => Promise<any> = async (
  web3Provider?: ethers.providers.Web3Provider,
) => {
  if (!web3Provider) {
    throw new Error('web3Provider not connected');
...
export const testSignTransaction: () => Promise<any> = async (
  web3Provider?: ethers.providers.Web3Provider,
) => {
  // if (!web3Provider) {
  //   throw new Error('web3Provider not connected');
